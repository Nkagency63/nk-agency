...
const services: Service[] = [{
  ...
  features: ["Tubes néon véritables ou LED flexibles pour l'effet néon", "Large choix de couleurs vibrantes", "Design personnalisé selon vos besoins", "Installation intérieure ou extérieure", "Consommation électrique optimisée"],
  ...
  features: ["Lettres en acrylique, métal, PVC ou aluminium", "Rétroéclairage LED à haute luminosité", "Épaisseur et police personnalisables", "Finitions diverses (brossée, laquée, etc.)", "Installation sécurisée par notre équipe"],
  ...
  features: ["Caissons simple ou double face", "Éclairage LED uniforme et économique", "Structure en aluminium durable", "Options de formes standard ou sur mesure", "Résistance aux intempéries"],
  ...
  features: ["Modules LED haute performance", "Programmable pour animations lumineuses", "Faible consommation énergétique", "Durée de vie supérieure (50 000+ heures)", "Maintenance réduite"],
  ...
  features: ["Impression haute définition", "Éclairage uniforme sans points chauds", "Changement facile des visuels", "Cadres fins et discrets", "Options intérieures et extérieures"],
  ...
  return <div className="pt-24 pb-20">
      ...
      <div className="container mx-auto px-4">
        <div className="space-y-24">
          {services.map((service, index) => <div key={service.id} className={`flex flex-col ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'} gap-10 items-center`}>
              ...
              <div className="w-full md:w-1/2">
                ...
                <ul className="space-y-3 mb-8">
                  {service.features.map((feature, fIndex) => <li key={fIndex} className="flex items-start">
                      <CheckCircle size={18} className="text-white mr-3 mt-1 shrink-0" />
                      <span className="text-gray-300">{feature}</span>
                    </li>)}
                </ul>

                <Link to="/quote" className="inline-block bg-white text-black px-6 py-3 rounded font-medium transition-all hover:bg-opacity-80">
                  Demander un devis
                </Link>
              </div>
            </div>)}
      ...
      <section className="py-20 mt-16 bg-secondary">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            step: "03"
          }].map((step, index) => <div key={index} className="bg-black p-8 rounded-xl border border-gray-800">
