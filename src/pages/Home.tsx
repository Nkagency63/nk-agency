            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  "Créations 100% personnalisées selon vos besoins",
                  "Qualité supérieure et matériaux durables",
                  "Service d'installation inclus partout en France",
                  "Suivi et maintenance de vos enseignes"
                ].map((item, index) => (
